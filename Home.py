...
def modulo_ventas():
    ...
    # Mostrar datos del cliente seleccionado si no estamos agregando o editando cliente
    ...
    # Continuar con el flujo normal si no estamos agregando o editando cliente
    if not st.session_state.get('mostrar_formulario_cliente', False) and not st.session_state.get('mostrar_formulario_editar_cliente', False):
        # Rest of your code here (e.g., vendedor asignado, rubros, buscador de productos, pedido actual)

        # Vendedor asignado
        if cliente_seleccionado != '':
            cliente_data = st.session_state.df_clientes[st.session_state.df_clientes['Nombre'] == cliente_seleccionado].iloc[0]
            vendedores = [cliente_data['Vendedores']] if pd.notna(cliente_data['Vendedores']) else ['No asignado']
        ...
        # Rest of your code for rubros, buscador de productos, pedido actual
        # ...

        # (Include the rest of your code for the module here, as in your original version.)
