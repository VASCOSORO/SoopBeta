...
def modulo_equipo():
    ...
    miembro_seleccionado = st.selectbox("Seleccionar Miembro del Equipo", [""] + st.session_state.df_equipo['Nombre'].unique().tolist())
    ...
    # Opciones de gestión para Super Admin
    if st.session_state.usuario['Nivel de Acceso'] == 'Super Admin':
        st.subheader("🔧 Gestionar Equipo")
        # Aquí irían los formularios para agregar, modificar o eliminar miembros
